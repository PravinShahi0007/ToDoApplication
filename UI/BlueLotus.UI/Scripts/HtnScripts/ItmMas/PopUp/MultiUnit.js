...
//    $("#HdrSec1_ItemMulti_Nm").width(700);
...
function GetUnits() {
    var ItemCode = $("#HdrSec1_ItemMulti_Cd").data("kendoComboBox").text();
    $.ajax({
...
function LoadDropDownMulti() {

    $("#HdrSec1_ItemMulti_Cd").kendoComboBox({
        dataValueField: "ItmKy",
        dataTextField: "ItmCd",
        dataSource: ItmCdDatasource('HdrSec1_ItemMulti'),// ItmCdDatasourceTest('HdrSec1_CmbItm'),
        change: function (e) {
            var cmb = $("#HdrSec1_ItemMulti_Cd").data("kendoComboBox");
            var val = cmb.value();
            if (isNaN(val)) {
                ...
                $("#HdrSec1_ItemMulti_Nm").data("kendoComboBox").value(val);
                GetUnits();
            }
    ...
    $("#HdrSec1_ItemMulti_Nm").kendoComboBox({
        dataValueField: "ItmKy",
        dataTextField: "ItmNm",
        dataSource: ItmNmDatasource('HdrSec1_ItemMulti'),// ItmCdDatasourceTest('HdrSec1_CmbItm'),
        change: function (e) {
            var cmb = $("#HdrSec1_ItemMulti_Nm").data("kendoComboBox");
            var val = cmb.value();
            if (isNaN(val)) {
                alert("'" + val + "' is not a Valid input");
                cmb.value("");
                ...
                $("#HdrSec1_ItemMulti_Cd").data("kendoComboBox").value(val);
                GetUnits();
            }
    ...
    $("#HdrSec1_ItemMulti_Cd").parent().css("width", "40%");
    $("#HdrSec1_ItemMulti_Nm").parent().css("width", "40%");
    $("#HdrSec1_CmbUnit_Cd").parent().css("width", "40%");
