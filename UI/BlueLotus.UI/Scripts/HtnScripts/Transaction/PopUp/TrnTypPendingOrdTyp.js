...
function SearchPurOrd() {
    ...
    var SupKy = $("#TrnTypOrd_OrdtypOrdcmbSupGRN").data('kendoComboBox').value();
...
function CancelPurOrd() {
    ...
    //$("#TrnTypOrd_FrmDateFromPR").data("kendoDatePicker").value("");
...
$("#TrnTypOrd_FindFromPOGrid").on("dblclick", "tr.k-state-selected", function () {
    ...
    var gridTrnTypOrd = $('#TrnTypOrd_FindFromPOGrid').data().kendoGrid;
    var selectedItemTrnTypOrd = gridTrnTypOrd.dataItem(gridTrnTypOrd.select());
    var ordKy = selectedItemTrnTypOrd.OrdKy;
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.length > 0) {
                ...
                $("#HdrSec2_CmbRepAdr_Cd").data("kendoComboBox").value(data[i].RepAdrKy);                
                //$("#HdrSec2_CmbRepAdr_Nm").data("kendoComboBox").value(data[i].RepAdrKy);                
                //$("HdrSec2_CmbRepAdr_Cd").data("kendoComboBox").trigger("change");
                ...
                $("#HdrSec3_CmbPmtTrms_Cd").data("kendoComboBox").value(data[i].PmtKy);
                //========================================================= Grid Binding
...
function TrnTypOrdTypSelect(ConCd, OurCd) {
    ...
    if (TrnTypOrdTypSelect_GetFromPurOrd_IsOpen) {
        ...
        TrnTypOrdTypSelect_GetFromPurOrd_IsOpen = true;
    }
    ...
    $("#GetFromPurOrd_wnd_title").html(Title);
