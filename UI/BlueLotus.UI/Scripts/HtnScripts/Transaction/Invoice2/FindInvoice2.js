...
$('#FindFormGridGRN').dblclick(function () {
    if (viewBag.OurCd == "RESUSAG") {
        LoadResourceUsage();

    }
    else if (viewBag.OurCd == "PrjPrgrsSubCon") {
        LoadDailyProgress();
    }
    else if (viewBag.OurCd == "PrjPrgrsDaily") {
        LoadDailyProgress();
    }
    else if (viewBag.OurCd == "ImpCost") {
        getSeclectedTrnKy();
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                var ComisPer = data[0].ComisPer;
                $("#HdrSec9_ComisPer_Val").data("kendoNumericTextBox").value(ComisPer);
                var RepComisPer = data[0].RepComisPer;
                $("#HdrSec9_RepComisPer_Val").data("kendoNumericTextBox").value(RepComisPer);
                var Amt1 = data[0].Amt1;
                $("#HdrSec9_Amt1_Val").data("kendoNumericTextBox").value(Amt1);
                var Amt2 = data[0].Amt2;
                $("#HdrSec9_Amt2_Val").data("kendoNumericTextBox").value(Amt2);
                var Amt3 = data[0].Amt3;
                $("#HdrSec9_Amt3_Val").data("kendoNumericTextBox").value(Amt3);
                var Amt4 = data[0].Amt4;
                $("#HdrSec9_Amt4_Val").data("kendoNumericTextBox").value(Amt4);
                var Amt5 = data[0].Amt5;
                $("#HdrSec9_Amt5_Val").data("kendoNumericTextBox").value(Amt5);
                var Amt6 = data[0].Amt6;
                $("#HdrSec9_Amt6_Val").data("kendoNumericTextBox").value(Amt6);
        ...
        success: function (data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                $(id).data("kendoGrid").dataSource.add({
                    ...
                    TaskUnitKy: data[i].TaskUnitKy,
                    TaskUnit: data[i].TaskUnit
                });
            }
            Calculatetotal();
            CreateNewGridRow();
