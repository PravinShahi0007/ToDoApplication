...
ObjectEvent.prototype.unsubscribe=function(a,b){this.__noOfDirtyItems=this.__noOfDirtyItems||0;if(b)for(var c=0;c<this._thisArgs.length;c++){if(this._thisArgs[c]===b){this._crntIndex==c&&(this._crntIndex--,this.__noOfDirtyItems++,this.__removedDirtyItemIndices.push(c));this.fn.splice(c,1);this._thisArgs.splice(c,1);break}}else for(c=0;c<this.fn.length;c++)if(this.fn[c]===a){-1<this._crntIndex&&(this.__noOfDirtyItems++,this.__removedDirtyItemIndices.push(c));this.fn.splice(c,1);this._thisArgs.splice(c,
...
rqFG.HierarchicalItem.prototype.GetChildList=function(){!1==this._childListResolved?(this._childListResolved=!0,this._resolvedChildList=null,null!=this._parent._fnChildListResolver&&(this._resolvedChildList=this._parent._fnChildListResolver(this.data))):null!=this._parent.dynamicResolver&&!0==this._forceToCreateNewChildList&&(this._forceToCreateNewChildList=!1,this._resolvedChildList=this._parent.dynamicResolver(this.data));return this._resolvedChildList};
...
a,this.property)),this._value=b.Convert&&"function"==typeof b.Convert?"function"==typeof a[this.property]?b.Convert.call(a,a[this.property]()):b.Convert.call(a,a[this.property],a):"function"==typeof a[this.property]?a[this.property]():a[this.property],a.PropertyChanged&&!1==a.PropertyChanged.isSubscribed(this.sourcePropertyChanged,e)&&a.PropertyChanged.subscribe(this.sourcePropertyChanged,e),this};
...
this._value);this._isValueUpdating=!1}},enumerable:!0,configurable:!0}));RadiantQ.Gantt.Utils.ValueBinder.prototype.sourcePropertyChanged=function(a,b){var c=-1,c="function"==typeof a.ID?a.ID():a.ID,c=this.GetActivityById(c);null==c||0<c.ChildActivities.length&&("StartTime"==b.PropertyName||"EndTime"==b.PropertyName||"Effort"==b.PropertyName)||(c=c._boundProps[b.PropertyName])&&!1==c._isValueUpdating&&(c.Value=b.Value)};
...
(a.Parent.element.options.Data.TableRow.rowIndex+1)+' does not have a property called "'+a.TaskEndTime+'". Specify a correct TaskEndTime value.')))},DataPropertyChangeFunction:function(a,b){"StartTime"!=b.PropertyName&&"EndTime"!=b.PropertyName||RadiantQ.Gantt.Utils.DelayUpdateUtil.TryDelayedUpdate(this)},PartialUpdate:function(){this.options.Parent.element.RedrawTaskRow()},TotalUpdate:function(){this.options.Parent.element.RedrawTaskRow()},_destroy:function(){this.options.Data.PropertyChanged&&this.options.Data.PropertyChanged.unsubscribe(this.DataPropertyChangeFunction,
this);if(this.options.Parent&&this.options.Parent.element){var a=this.options.Parent.element._getIntersectingBlock(this,this.options.Parent.element);this.options.Parent.element.RemoveEntity(a,this)}},propertyChangeFuction:function(a,b){},DragEnd:function(a,b){if(!a.options.StartTime.equals(b.originalStart)||!a.options.EndTime.equals(b.originalEnd)){if(0<a.options.FlexyGantt.TaskTimeChanged.fn.length){var c=new TimesChangingEventArgs(a.options.Data,b.originalStart,b.originalEnd,"DragEnd",a.options.DataSource);
a.options.FlexyGantt.TaskTimeChanged.raise(this,c);b.originalStart=c.StartTime;b.originalEnd=c.EndTime}a._setOption("StartTime",b.originalStart);a._setOption("EndTime",b.originalEnd);a.options.Parent.element.RedrawTaskRow()}},ResizeEnd:function(a,b){if(!a.options.EndTime.equals(b.originalEnd)){if(0<a.options.FlexyGantt.TaskTimeChanged.fn.length){var c=new TimesChangingEventArgs(a.options.Data,b.originalStart,b.originalEnd,"ResizeEnd",a.options.DataSource);a.options.FlexyGantt.TaskTimeChanged.raise(this,
...
TooltipContent:null,DragTooltipContent:null,ResizeTooltipContent:null,ApplyTooltipSettings:function(a){a.attr("title","");this.LoadDefaultTooltipStyle();this.CreateTooltip(this,a);this.UpdateTooltipContent(this.options.Data)},CreateTooltip:function(b,c){a(c).tooltip({open:function(a,c){a.currentTarget.isDragging?isDragging=a.currentTarget.isDragging:a.currentTarget.isResizing&&(isResizing=a.currentTarget.isResizing);a.currentTarget.uiTooltip=c.tooltip;b.uiTooltip=c.tooltip},isDragging:!1,isResizing:!1,
content:function(c){if(this.isDragging||this.isResizing)return null;this.isDragging=this.isResizing=!1;if(!b.TooltipContent)return null;b.uiTooltip&&a(".ui-tooltip").remove().removeAttr("aria-describedby");return b.TooltipContent},position:{my:"left bottom",at:"top",offset:"10"},track:!0});var d=!1;a(c).hover(function(){d=!0},function(){d=!1});a(c).mouseout(function(){d||a(".ui-tooltip").remove().removeAttr("aria-describedby")})},UpdateTooltipContent:function(b){if(b.ProposedStart&&b.ProposedEnd){0==
b.OriginalStart.compareTo(b.ProposedStart)&&0==b.OriginalEnd.compareTo(b.ProposedEnd)&&(b.HasChanged=!1);var c={Name:b.Name,StartTime:b.ProposedStart,DataSource:this.options.Data,EndTime:b.ProposedEnd,OriginalStart:b.OriginalStart,OriginalEnd:b.OriginalEnd,HasChanged:b.HasChanged};if(b.Duration){if(0>b.Duration.days)return;c.Duration=b.Duration}this.options.MovingInfoPopup=a.template(null,this.options.MovingInfoPopup);this.options.ResizeInfoPopup=a.template(null,this.options.ResizeInfoPopup);this.DragTooltipContent=
a('<div align="center" />').append(a.tmpl(this.options.MovingInfoPopup,c));this.ResizeTooltipContent=a('<div align="center" />').append(a.tmpl(this.options.ResizeInfoPopup,c))}else b[_taskbar.stSourceBinding]&&b[_taskbar.etSourceBinding]&&this.options.TaskTooltipTemplate&&(this.TooltipContent=a('<div class="TaskTooltip" />').append(a.tmpl(this.options.TaskTooltipTemplate,b,{isParentType:this.options.IsParentTypeRow,DataContext:this})))},LoadDefaultTooltipStyle:function(){a.isFunction(_taskbar.options.Data[_taskbar.stSourceBinding]);
a.isFunction(_taskbar.options.Data[_taskbar.stSourceBinding]);_taskbar.options.MovingInfoPopup||(_taskbar.options.MovingInfoPopup="<div><table class='rq-gc-taskbar-popup' style='white-space:nowrap;'><tr><td colspan='2' align='center'><b>${RadiantQ_TaskString}</b></td></tr><tr><td style='float:right;'><b>${RadiantQ_StartString} :</b></td><td> "+_taskbar._MakeItBoldWhenActualDate("${$item.data.StartTime.toString('yyyy-MM-dd HH:mm')}")+"</td></tr><tr><td style='float:right;'><b>${RadiantQ_FinishString}:</b> </td><td> "+
_taskbar._MakeItBoldWhenActualDate("${$item.data.EndTime.toString('yyyy-MM-dd HH:mm')}")+"</td></tr></table></div>");_taskbar.options.ResizeInfoPopup||(_taskbar.options.ResizeInfoPopup="<div><table class='rq-gc-taskbar-popup' style='white-space:nowrap;'><tr><td colspan='2' align='center'><b>${RadiantQ_TaskString}</b></td></tr><tr><td style='float:right;'><b>${RadiantQ_DurationString} :</b></td><td> "+_taskbar._MakeItBoldWhenActualDate("{{if Duration}}${$item.data.Duration.days}d ${$item.data.Duration.hours} h{{/if}}")+
"</td></tr><tr><td style='float:right;'><b>${RadiantQ_StartTimeString} :</b> </td><td> "+_taskbar._MakeItBoldWhenActualDate("${$item.data.StartTime.toString('yyyy-MM-dd HH:mm')}")+"</td></tr><tr><td style='float:right;'><b>${RadiantQ_EndTimeString} :</b></td><td> "+_taskbar._MakeItBoldWhenActualDate("${$item.data.EndTime.toString('yyyy-MM-dd HH:mm')}")+"</td></tr></table></div>")},_MakeItBoldWhenActualDate:function(a){return"{{if HasChanged }}"+a+"{{else}}<b>"+a+"</b>{{/if}}"},LocationRecomputed:new ObjectEvent("LocationRecomputed"),
_OnRecomputeLocation:function(a){var b=parseFloat(a.css("width")),c=parseFloat(a.css("margin-left")),d=this.options,e=this.options.GanttChart,f=e.options,m=f.BaseTimeScaleType,q=f.ComputedStartTime,r=f.BaseTimeUnitWidth;if(null!=this.options.GanttChart){var s=rqTCUtils.ConvertToUnitsOfBaseScaleType(m,q,d.StartTime,null)*r,t=0,t=d.EndTime<d.StartTime?0:rqTCUtils.ConvertToUnitsOfBaseScaleType(m,d.StartTime,d.EndTime,null)*r,t=t-1;0>t&&(t=1);var u=s;0>u+t||u>f.ViewWidth||(f=this._GetBarRenderStartTime(d.StartTime),
u=this._GetBarRenderStartTime(d.EndTime),(f!=d.StartTime||u!=d.EndTime)&&f<u&&(t=rqTCUtils.ConvertToUnitsOfBaseScaleType(m,f,u,null)*r,s=rqTCUtils.ConvertToUnitsOfBaseScaleType(m,q,f,null)*r));m=null;d={Data:this.options.Data,UseWidthForVerticalLines:!1,IsShifting:!1,UseWidthForTaskBar:!0};null!=this.options.GanttChart.options.ProvideWidthForMilestoneShape&&(m=this.options.GanttChart.options.ProvideWidthForMilestoneShape(this,d));null!=m&&!0==d.UseWidthForTaskBar&&(s-=m/2,t=m);a.css("width",t+"px").css("margin-left",
s+"px");this.options.OverlappedTasksRenderingOptimization!=RadiantQ.FlexyGantt.OverlappedTasksRenderingOptimization.ShrinkHeight||b==t&&c==s||(this.currentBlock=this.options.Parent.element._getIntersectingBlocks(this,this.options.Parent.element),this.options.Parent.element._blockIntact(this.currentBlock));0<this.LocationRecomputed.fn.length&&this.LocationRecomputed.raise(this);b=a.find("div.rq-gc-start-verticalLine");c=a.find("div.rq-gc-end-verticalLine");if(0!=b.length||0!=c.length)q=a.closest("tr"),
q.length&&(t=parseInt(a.css("margin-top")),a.height(),s=a.width(),q=q[0].offsetTop,r=0,!0==d.UseWidthForVerticalLines&&(r=m/2),t={height:q+t+"px","margin-left":r+"px","margin-top":-(q+t)+"px"},0!=b.length&&b.css(t),0!=c.length&&(!1==d.UseWidthForVerticalLines&&(t["margin-left"]=s+"px"),c.css(t)));s=this.options.GanttChart.options.TimeIndicatorLineOption;(s&ns_gantt.TimeIndicatorLines.Always)!=ns_gantt.TimeIndicatorLines.Always||(s&ns_gantt.TimeIndicatorLines.OnResize)==ns_gantt.TimeIndicatorLines.OnResize?
(b.hide(),c.hide()):(b.show(),c.show());b=this.element.attr("SizeChanged");window[b]&&window[b].call(this.element,this.options.Data,e);this.options.FlexyGantt.options&&(e=this.options.FlexyGantt.options.OnTaskBarLoad,null!=e&&"function"==typeof e&&e.call(a,this))}},_GetBarRenderStartTime:function(a){if(this.options.ApplyBarWidthOptimization){var b=this._ConvertXToTime(-10);if(a<b)return b}return a},_beginUpdateOverlapTasks:function(a){if(this.options.OverlappedTasksRenderingOptimization==RadiantQ.FlexyGantt.OverlappedTasksRenderingOptimization.ShrinkHeight){var b=
this.options.Parent.element;this.currentBlock=b._getIntersectingBlock(a,b)}},_endUpdateOverlapTasks:function(a){if(this.options.OverlappedTasksRenderingOptimization==RadiantQ.FlexyGantt.OverlappedTasksRenderingOptimization.ShrinkHeight){var b=this.options.Parent.element;null!=this.currentBlock&&(b._blockIntact([this.currentBlock]),this.currentBlock=null);a=b._getIntersectingBlocks(a);null!=a&&0<a.length&&b._blockIntact(a)}},_updateTaskItem:function(b,c,d,e){var f=this.element,p=RadiantQ.FlexyGantt.TaskItemControl,
m=p.MarginForBars,q=a(f.parent().parent())[0];if(void 0!=q){var q=parseInt(q.style.height),m=2*m,r=f[0].style.borderTopWidth,s=0,s=f[0].style.borderBottomWidth;f.hasClass("rq-gc-parentBar")&&f.hasClass("parentBar-style")?(r="0px"==r||""==r?p.ParentBar_BorderTopWidth:parseInt(r),p="0px"==s||""==s?p.ParentBar_BorderBottomWidth:parseInt(f[0].style.borderBottomWidth),s=(q-m-(r+p))/e):(f="0px"==r||""==r?p.TaskBar_BorderTopWidth:parseInt(r),p="0px"==s||""==s?p.TaskBar_BorderBottomWidth:parseInt(s),s=(q-
m-(f+p))/e);void 0!=e&&(c=s);d?(b=0==b||void 0!=this.element.attr("heightSetBySrc")?b*c+RadiantQ.FlexyGantt.TaskItemControl.MarginForBars:b*(c+2*RadiantQ.FlexyGantt.TaskItemControl.MarginForBars+2)+RadiantQ.FlexyGantt.TaskItemControl.MarginForBars,this.element.css("height",c+"px").css("margin-top",b+"px"),a.isFunction(this.options.Data.IsOverlapping)?this.options.Data.IsOverlapping(!0):this.options.Data.IsOverlapping=!0):(this.element.css("height",c+"px").css("margin-top",RadiantQ.FlexyGantt.TaskItemControl.MarginForBars+
"px"),a.isFunction(this.options.Data.IsOverlapping)?this.options.Data.IsOverlapping(!1):this.options.Data.IsOverlapping=!1)}},_ConvertXToTime:function(a){var b=this.options,c=b.GanttChart.options;return b.ComputedStartTime+rqTCUtils.ConvertTimeUnitsToTimeSpan(c.BaseTimeScaleType,a/c.baseTimeUnitWidth)},_setOption:function(b,c){if("StartTime"==b||"EndTime"==b){var d;d="StartTime"==b?this.options.StartTime:this.options.EndTime;if(!d.equals(c)){a.Widget.prototype._setOption.apply(this,arguments);switch(b){case "StartTime":this._updateStartAndEnd("StartTime");
this.options.Parent.element.UpdateItemForCue(this.options.Data,c,d);break;case "EndTime":this._updateStartAndEnd("EndTime");break;case "TimeIndicatorLineOption":this._OnRecomputeLocation(this.element)}this.UpdateTooltipContent(this.options.Data);this._trigger("startAndEndTimeChange",this,this.options.Data)}}},_updateStartAndEnd:function(b){switch(b){case "StartTime":this.options.StartTime&&(b=this.options.Data[this.stSourceBinding],a.isFunction(b)?b()!=this.options.StartTime&&b(this.options.StartTime.clone()):
this.options.Data[this.stSourceBinding]=this.options.StartTime.clone());break;case "EndTime":this.options.EndTime&&(b=this.options.Data[this.etSourceBinding],a.isFunction(b)?b()!=this.options.EndTime&&b(this.options.EndTime.clone()):this.options.Data[this.etSourceBinding]=this.options.EndTime.clone())}}});RadiantQ.FlexyGantt.ShiftTrackerGlobal={IncludeVerticalMovingSupport:!1,TrackingTaskItemControl:null,CurrentDropRow:null,CurrentStartRow:null,deltaX:null,deltaY:null,GetDropCueLocationIn:function(a){},
BeginVerticalDrag:new ObjectEvent("BeginVerticalDrag"),VerticalDragOver:new ObjectEvent("VerticalDragOver"),VerticalDragDrop:new ObjectEvent("VerticalDragDrop")};var b=null,c=null,d=null,e=!1,f=!1;a.fn.shiftTracker=function(g,h,k,l){var n,p,m,q=this;this.widgetName="TaskItemControl";var r,s,t,u,y,w;stElementInfocollection.push({element:q,taskStartAndEndTime:g,TaskItemControl:h});var x=new ObjectEvent("DragComplet"),z=0,v=RadiantQ.FlexyGantt.ShiftTrackerGlobal,D=v.IncludeVerticalMovingSupport,I=v.BeginVerticalDrag,
J=v.VerticalDragOver,K=v.VerticalDragDrop,L;h.IsVerticallyMoving=function(){return IsVerticallyMoving};var A=!1;q.dblclick(function(){H=0;clearTimeout(G)});var G=null,H=0,B=!1,C=this;q.bind("mousedown."+this.widgetName,function(b){if(!a(b.target).hasClass("label")&&"collapse"!=l.css("visibility")){b.preventDefault();B=!1;var c=b.screenX,d=b.screenY,e=_commonMouseDown(b,q,B);u=function(a){return _mouseMove(a,e,q,B)};y=function(b){b.screenX==c&&b.screenY==d?(null!=G&&clearTimeout(G),H++,q.click(),G=
setTimeout(function(){2<=H&&(q.dblclick(),H=0)},80),b=a(document),b.unbind("mousemove."+C.widgetName).unbind("mouseup."+C.widgetName).unbind("keydown"),b.unbind("touchmove."+C.widgetName).unbind("touchend."+C.widgetName).unbind("keydown"),a("#clone").remove()):_mouseUp(b,e,q,B)};a(document).bind("mousemove."+C.widgetName,u).bind("mouseup."+C.widgetName,y)}});q.bind("touchstart."+this.widgetName,function(b){if(!a(b.target).hasClass("label")){B=!0;b.preventDefault();b.stopPropagation();var c=_commonMouseDown(b,
q,B);u=function(a){return _mouseMove(a,c,q,B)};y=function(a){return _mouseUp(a,c,q,B)};a(document).bind("touchmove."+C.widgetName,u).bind("touchend."+C.widgetName,y)}});var F=0;_commonMouseDown=function(b,c,d){D=v.IncludeVerticalMovingSupport;I=v.BeginVerticalDrag;J=v.VerticalDragOver;K=v.VerticalDragDrop;var e=b.srcElement;if(!a(e).hasClass("resizer-style")||!a(e).hasClass("rq-fg-gc-taskBarResizer")){var e=c[0].offsetWidth,f=c.height();w=l.clone();w[0].id="clone";w.addClass("taskclone rq-taskbar-clone");
var g=!0,h=c.data("TaskBar");v.TrackingTaskItemControl=h;var k=h.options.GanttChart.options.TimeIndicatorLineOption;if((k&ns_gantt.TimeIndicatorLines.OnResize)==ns_gantt.TimeIndicatorLines.OnResize||(k&ns_gantt.TimeIndicatorLines.Always)==ns_gantt.TimeIndicatorLines.Always)$startVerticalLineClone=c.find("div.rq-gc-start-verticalLine").clone().show(),$endVerticalLineClone=c.find("div.rq-gc-end-verticalLine").clone().show(),k={Data:h.options.Data,UseWidthForVerticalLines:!1,IsShifting:!0,UseWidthForTaskBar:!0},
h=h.options.GanttChart.options.ProvideWidthForMilestoneShape,null!=h&&(w.css("width",e+"px"),h=h(this,k),null!=h&&(g=!1,F=0,!0==k.UseWidthForTaskBar&&(F=h/2,w.css("margin-left",-F+"px"),w.css("width",e+"px")),k.UseWidthForVerticalLines=!0,F=h/2,$startVerticalLineClone.css("margin-left",F+"px"),$endVerticalLineClone.css("margin-left",F+"px"))),w.append($startVerticalLineClone),w.append($endVerticalLineClone);!0==g&&w.css("width",e-2+"px");w.css("height",f-1+"px");w.appendTo(c);_mouseClick(b,w,c,d);
b.stopPropagation()}return w};_mouseClick=function(b,c,e,k){var l;f=!1;void 0!=b.originalEvent.touches||null!=b.originalEvent.touches?(v.deltaX=0,v.deltaY=0):(v.deltaX=void 0==b.offsetX?b.originalEvent.layerX:b.offsetX,v.deltaY=void 0==b.offsetY?b.originalEvent.layerY:b.offsetY);b||(b=window.event);b.which?l=3==b.which:b.button&&(l=2==b.button);if(!l){e[0].uiTooltip&&(e[0].isDragging=!0);l=_getDargMousePosition(b,c,e,k);d=a(b.target).closest("tr");r=l.x;s=l.y;t=c[0].offsetLeft;for(c=0;c<stElementInfocollection.length;c++)stElementInfocollection[c].element==
e&&(g=stElementInfocollection[c].taskStartAndEndTime,h=stElementInfocollection[c].TaskItemControl,h._beginUpdateOverlapTasks(h));g.ProposedStart=g.originalStart;g.ProposedEnd=g.originalEnd;g.OriginalStart=g.originalStart;g.OriginalEnd=g.originalEnd;g.originalLeft=parseFloat(a(e).css("margin-left"));h.UpdateTooltipContent(g);v.CurrentStartRow=h.options.DataSource;a(this).GetDragOrResizeContent(h.DragTooltipContent,b,e,k);a(document).bind("keydown",function(b){27==b.keyCode&&(a(document).unbind("mousemove."+
C.widgetName).unbind("mouseup."+C.widgetName).unbind("keydown"),a(this).RemoveDragOrResizeContent(e),a("#clone").remove(),f=!0,b.cancel=!0,v.CurrentDropRow=null,_onVerticalDragDrop(b,!1))})}};_mouseMove=function(b,c,d,f){e&&a("#clone").css("display","none");for(var k=0;k<stElementInfocollection.length;k++)stElementInfocollection[k].element==d&&null!=stElementInfocollection[k].taskStartAndEndTime.originalStart&&(n=h.options.GanttChart.options.Parent.RoundUp(stElementInfocollection[k].taskStartAndEndTime.originalStart.clone()),
p=h.options.GanttChart.options.Parent.RoundUp(stElementInfocollection[k].taskStartAndEndTime.originalEnd.clone()),m=stElementInfocollection[k].taskStartAndEndTime.originalLeft);n<=p&&(_updatePosition(b,c,d,f),h.UpdateTooltipContent(g),b=a(".dragPopup"),a(b).empty(),a(b).append(h.DragTooltipContent),a(b).css("visibility","visible"),d[0].uiTooltip&&d[0].uiTooltip.hide())};_mouseUp=function(b,c,d){clearAutoScrollTimers();null!=g.ProposedStart&&null!=g.ProposedEnd&&(d[0].uiTooltip&&(d[0].isDragging=!1),
a(this).RemoveDragOrResizeContent(d),a(c).css("margin-left")&&(d=a(d).css("margin-left"),""==d&&(d=0),c=a(c).css("margin-left"),parseInt(c),parseInt(d)),g.originalStart=g.ProposedStart,g.originalEnd=g.ProposedEnd,g.OriginalStart=g.originalStart,g.OriginalEnd=g.originalEnd,h._endUpdateOverlapTasks(h),x.subscribe(k),x.raise(h,g));_updateCurrentDropRow(b,_onVerticalDragDrop,!1);a(document).unbind("mousemove."+C.widgetName).unbind("mouseup."+C.widgetName).unbind("keydown");a(document).unbind("touchmove."+
C.widgetName).unbind("touchend."+C.widgetName).unbind("keydown");a("#clone").remove()};_getDargMousePosition=function(a,b,c,d){c=b=0;if(!0==d)if(a.originalEvent.touches[0].pageX||a.originalEvent.touches[0].pageY)b=a.originalEvent.touches[0].pageX,c=a.originalEvent.touches[0].pageY;else{if(a.originalEvent.touches[0].clientX||a.originalEvent.touches[0].clientY)b=a.originalEvent.touches[0].clientX,c=a.originalEvent.touches[0].clientY}else if(a.pageX||a.pageY)b=a.pageX,c=a.pageY;else if(a.clientX||a.clientY)b=
a.clientX,c=a.clientY;return{x:b,y:c}};_mouseMovedTo=function(b,c,d){z++;if(!(6>z&&D))if(L=b,!1==e&&!1==A&&(4<=Math.abs(c)&&D&&_canBeginVerticalDrag(d)?e=!0:4<=Math.abs(b)&&(A=!0)),clearAutoScrollTimers(),b=e,v.GetDropCueLocationIn(d).Y<N+O/2&&b?_tableAutoScrollUp():v.GetDropCueLocationIn(d).Y>N+E[0].clientHeight-O/2&&b&&_tableAutoScrollDown(),b)f||(a("#clone").remove(),a(".dragPopup").remove(),_updateCurrentDropRow(d,_onVerticalDragOver,!0));else if(A){parseInt(w.css("height"));b=m+F;b=rqTCUtils.ConvertToEndTimeInBaseScaleType(h.options.GanttChart.options.BaseTimeScaleType,
n.clone(),b/h.options.GanttChart.options.BaseTimeUnitWidth,(b+L)/h.options.GanttChart.options.BaseTimeUnitWidth,null);var k=Date.today();c={Value:b};k={Value:k};h.options.FlexyGantt.ConvertToValidTimes(h.options.Data,b,rqTCUtils.GetTimeSpan(n,p),c,k,"Move",d,h.element);b=c.Value;k=k.Value;g.ProposedStart=h.options.GanttChart.options.Parent.RoundUp(b);g.ProposedEnd=h.options.GanttChart.options.Parent.RoundUp(k);0==g.ProposedStart.compareTo(g.OriginalStart)&&0==g.ProposedEnd.compareTo(g.OriginalEnd)?
g.HasChanged=!1:g.HasChanged=!0}};_updatePosition=function(b,c,f,g){g=_getDargMousePosition(b,c,f,g);b.shouldSyncDragCue=!1;var h=d;h&&0!=h.length&&(b.row_index=h[0].rowIndex,-1==b.row_index&&(b.row_index=a("tr",a(f).closest("table")).index(h)),f=g.x-r+t,_mouseMovedTo(g.x-r,g.y-s,b),!0==b.shouldSyncDragCue||e||c.css("margin-left",f+"px"))};v.GetDropCueLocationIn=function(a){if(void 0!=a.originalEvent.touches&&null!=a.originalEvent.touches&&0<a.originalEvent.touches.length)if(a.originalEvent.touches[0].pageX||
...
else{if(a.originalEvent.changedTouches[0].clientX||a.originalEvent.changedTouches[0].clientY)posx=a.originalEvent.changedTouches[0].clientX,posy=a.originalEvent.changedTouches[0].clientY}else if(a.pageX||a.pageY)posx=a.pageX,posy=a.pageY;else if(a.clientX||a.clientY)posx=a.clientX,posy=a.clientY;return{X:posx,Y:posy}};_updateCurrentDropRow=function(b,c,d){var f;f=void 0!=b.originalEvent.changedTouches||null!=b.originalEvent.changedTouches?a(document.elementFromPoint(b.originalEvent.changedTouches[0].clientX,
b.originalEvent.changedTouches[0].clientY)).closest("td.FlexyChartRow"):void 0!=b.originalEvent.touches||null!=b.originalEvent.touches?a(document.elementFromPoint(b.originalEvent.changedTouches[0].clientX,b.originalEvent.changedTouches[0].clientY)).closest("td.FlexyChartRow"):a(b.target).closest("td.FlexyChartRow");v.CurrentDropRow=0<f.length&&e?f.parent()[0]["data-grid-item"]:null;c(b,d)};_canBeginVerticalDrag=function(a){if(I){var b={};b.event=a;b.cancel=!1;I.raise(this,b);return!1==b.cancel}return!0};
_onVerticalDragOver=function(a,b){f||(J&&J.raise(this,a),e=b)};_onVerticalDragDrop=function(a,b){K&&v.IncludeVerticalMovingSupport&&e&&K.raise(this,a);e=b};var M=C.data("TaskBar").options.FlexyGantt,E=a(".ui-grid-body",M.element),N=E.offset().top,O=M.options.RowHeight;_tableAutoScrollUp=function(){null==c&&(c=setInterval(function(){0<100*E[0].scrollTop/(E[0].scrollHeight-E[0].clientHeight)?_autoScroll(-10):clearAutoScrollTimers()},0))};_tableAutoScrollDown=function(){null==b&&(b=setInterval(function(){E[0].scrollHeight==
E[0].scrollTop+E[0].clientHeight?clearAutoScrollTimers():_autoScroll(10)},0))};_autoScroll=function(a){E.animate({scrollTop:E[0].scrollTop+a},0)};clearAutoScrollTimers=function(){null!=c&&clearInterval(c);null!=b&&clearInterval(b);c=b=null};this[0].mouseMovedTo=_updatePosition;this[0].mouseClick=_mouseClick};a.fn.resizeTracker=function(b,c,d,e,f,p){var m=this,q,r,s,t,u,y;rtElementInfocollection.push({element:m,taskStartAndEndTime:b,TaskItemControl:c});var w=new ObjectEvent("ResizeComplet");y=a("<div class='resizer-style rq-fg-gc-taskBarResizer'></div>");
var x=a("<div class='start-resizer-style rq-gc-startTaskBarResizer resizer-style rq-fg-gc-taskBarResizer'></div>");y.css("height",a(m).css("height"));y.css("margin-left",parseInt(a(m).css("width"))-4+"px");x.css("height",a(m).css("height"));var z=null,v=null,D=a(m).find("div.parentMiddleBar-style");a(m).find("div.parentMiddleBar-style");0!=D.length?(0<p.length&&x.appendTo(D),0<f.length&&y.appendTo(D)):(0<p.length&&x.appendTo(m),0<f.length&&y.appendTo(m));0<f.length&&(y.bind("mousedown."+this.widgetName,
function(b){b.preventDefault();var c=_commonResizerMouseDone(b,m,!1);s=function(a){return _resizerMouseMove(a,c,m)};t=function(a){return _resizerMouseUp(a,c,m)};a(document).bind("mousemove."+this.widgetName,s).bind("mouseup."+this.widgetName,t)}),y.bind("touchstart."+this.widgetName,function(b){b.preventDefault();var c=_commonResizerMouseDone(b,m,!0);s=function(a){return _resizerMouseMove(a,c,m,!0)};t=function(a){return _resizerMouseUp(a,c,m,!0)};a(document).bind("touchmove."+this.widgetName,s).bind("touchend."+
this.widgetName,t)}));0<p.length&&(x.bind("mousedown."+this.widgetName,function(b){b.preventDefault();var c=_commonResizerMouseDone(b,m,!1,!0);s=function(a){return _resizerMouseMove(a,c,m,null,!0)};t=function(a){return _resizerMouseUp(a,c,m,null,!0)};a(document).bind("mousemove."+this.widgetName,s).bind("mouseup."+this.widgetName,t)}),x.bind("touchstart."+this.widgetName,function(b){b.preventDefault();var c=_commonResizerMouseDone(b,m,!0,!0);s=function(a){return _resizerMouseMove(a,c,m,!0,!0)};t=
function(a){return _resizerMouseUp(a,c,m,!0,!0)};a(document).bind("touchmove."+this.widgetName,s).bind("touchend."+this.widgetName,t)}));_commonResizerMouseDone=function(b,d,e,g){u=f.clone();var k=d.height(),l=d[0].offsetWidth,m=2;!0==g&&(m=5);a(u).css("width",l-m+"px");a(u).addClass("taskclone rq-taskbar-clone");a(u).css("height",k-1+"px");u.appendTo(d);_resizerMouseClick(b,u,d,e);b.stopPropagation();b=c.options.GanttChart.options.TimeIndicatorLineOption;if((b&ns_gantt.TimeIndicatorLines.OnResize)==
ns_gantt.TimeIndicatorLines.OnResize||(b&ns_gantt.TimeIndicatorLines.Always)==ns_gantt.TimeIndicatorLines.Always)z=d.find("div.rq-gc-start-verticalLine").clone().show(),v=d.find("div.rq-gc-end-verticalLine").clone().show(),u.append(z),u.append(v);return u};var I=0;_resizerMouseClick=function(d,e,f,k){d.preventDefault();f[0].uiTooltip&&(f[0].isResizing=!0);q=_getMousePosition(d,e,f,k).x;r=parseFloat(f.css("width"));I=parseFloat(f.css("margin-left"));for(e=0;e<rtElementInfocollection.length;e++)rtElementInfocollection[e].element==
f&&(b=rtElementInfocollection[e].taskStartAndEndTime,c=rtElementInfocollection[e].TaskItemControl,c._beginUpdateOverlapTasks(c));b.ProposedStart=c.options.GanttChart.options.Parent.RoundUp(b.originalStart);b.ProposedEnd=c.options.GanttChart.options.Parent.RoundUp(b.originalEnd);b.OriginalStart=b.originalStart;b.OriginalEnd=b.originalEnd;b.OriginalDuration=rqTCUtils.GetTimeSpan(b.OriginalStart,b.OriginalEnd);b.OriginalLeft=b.originalLeft=parseFloat(f.css("margin-left"));b.originalWidth=parseFloat(f.css("width"));
b.OriginalWidth=b.originalWidth;this.ProposedDuration=b.OriginalDuration;c.UpdateTooltipContent(b);a(this).GetDragOrResizeContent(c.ResizeTooltipContent,d,f,k)};_resizerMouseMove=function(a,b,c,d,e){_updateWidth(a,b,c,d,e)};_resizerMouseUp=function(f,n,m,p,q){m[0].uiTooltip&&(m[0].isResizing=!1);a(this).RemoveDragOrResizeContent(m);a(n).css("width")&&a(m).css("width",a(n).css("width"));a(".resizeThumb").remove();c._endUpdateOverlapTasks(c);!0==q?w.subscribe(e):w.subscribe(d);w.raise(c,b);b.OriginalEnd=
b.originalEnd;b.OriginalDuration=this.ProposedDuration;b.OriginalStart=b.ProposedStart;c._OnRecomputeLocation(m);a(document).unbind("mousemove."+this.widgetName,s).unbind("mouseup."+this.widgetName,t).unbind("keydown");a(document).unbind("touchmove."+this.widgetName,s).unbind("touchend."+this.widgetName,t).unbind("keydown")};_resizeTo=function(d,e,f,k){b.HasChanged=b.OriginalDuration==this.ProposedDuration?!1:!0;d=rqTCUtils.ConvertUnitsInBaseScaleTypeToDurationInHours(c.options.GanttChart.options.BaseTimeScaleType,
b.originalStart,b.originalLeft/c.options.GanttChart.options.BaseTimeUnitWidth,(b.originalLeft+(d+2))/c.options.GanttChart.options.BaseTimeUnitWidth,null);d=new RQTimeSpan(0,d,0,0);k=b.originalStart.clone();var l=k.clone();l.addHours(d.getTotalHours());var n={Value:k},l={Value:l};c.options.FlexyGantt.ConvertToValidTimes(c.options.Data,b.originalStart.clone(),d,n,l,"ResizeAtEnd",e,f);l=l.Value;b.originalStart<l&&(b.ProposedStart=k,b.ProposedEnd=c.options.GanttChart.options.Parent.RoundUp(l.clone()),
b.Duration=rqTCUtils.GetTimeSpan(b.originalStart,l),d=rqTCUtils.GetTimeSpan(b.originalStart,l),this.ProposedDuration=c.options.GanttChart.options.Parent.RoundUpDuration(d),b.Duration=this.ProposedDuration,b.originalEnd=c.options.GanttChart.options.Parent.RoundUp(b.ProposedEnd),c.UpdateTooltipContent(b));e=a(".dragPopup");a(e).empty();a(e).append(c.ResizeTooltipContent);a(e).css("visibility","visible");f[0].uiTooltip&&f[0].uiTooltip.hide()};resizeStartTo=function(d,e,f){var k=rqTCUtils.ConvertToEndTimeInBaseScaleType(c.options.GanttChart.options.BaseTimeScaleType,
b.originalStart,b.OriginalLeft/c.options.GanttChart.options.BaseTimeUnitWidth,d/c.options.GanttChart.options.BaseTimeUnitWidth,null);d=rqTCUtils.ConvertUnitsInBaseScaleTypeToDurationInHours(c.options.GanttChart.options.BaseTimeScaleType,k,d/c.options.GanttChart.options.BaseTimeUnitWidth,(b.OriginalLeft+b.originalWidth)/c.options.GanttChart.options.BaseTimeUnitWidth,null);d=c.options.GanttChart.options.Parent.RoundUpDuration(new RQTimeSpan(0,d,0,0));k=b.originalEnd.clone().addTimeSpan(new RQTimeSpan(-d));
computedEnd=b.originalEnd;c.options.FlexyGantt.ConvertToValidTimes(c.options.Data,k,d,k,computedEnd,"ResizeAtStart",e,f);k=k.Value;computedEnd=computedEnd.Value;d=new RQTimeSpan(b.originalEnd-k);b.ProposedStart=b.originalEnd.clone().addTimeSpan(new RQTimeSpan(-d));b.originalStart=b.ProposedStart;this.ProposedDuration=b.ProposedDuration=d;b.Duration=d;c.UpdateTooltipContent(b);e=a(".dragPopup");a(e).empty();a(e).append(c.ResizeTooltipContent);a(e).css("visibility","visible");f[0].uiTooltip&&f[0].uiTooltip.hide()};
_getMousePosition=function(a,b,c,d){if(!0==d)if(a.originalEvent.touches[0].pageX||a.originalEvent.touches[0].pageY)var e=a.originalEvent.touches[0].pageX,f=a.originalEvent.touches[0].pageY;else{if(a.originalEvent.touches[0].clientX||a.originalEvent.touches[0].clientY)e=a.originalEvent.touches[0].clientX,f=a.originalEvent.touches[0].clientY}else if(a.pageX||a.pageY)e=a.pageX,f=a.pageY;else if(a.clientX||a.clientY)e=a.clientX,f=a.clientY;return{x:e,y:f}};_updateWidth=function(b,c,d,e,f){e=_getMousePosition(b,
c,d,e);if(!0==f){f=e.x-q;e=r-f;1<e?c.css("width",e+"px"):c.css("width","0px");if(-1<e)c.css("margin-left",f+"px");else return!1;null!=v&&0<v.length&&(v[0].style["margin-left"]=c.css("width"));resizeStartTo(I+f,b,d)}else e=e.x-q+r,0<e?c.css("width",e+"px"):c.css("width","0px"),null!=v&&0<v.length&&(v[0].style["margin-left"]=c.css("width")),_resizeTo(e,b,d);a(document).bind("keydown",function(b){27==b.keyCode&&(a(document).unbind("mousemove."+this.widgetName,s).unbind("mouseup."+this.widgetName,t).unbind("keydown"),
...
null!=a&&(c=this.options.Data._data[a]);!1==this.options.IsParentTypeRow&&this.options.Data&&(!1==c instanceof RadiantQ.RQ_ObservableCollection&&(!1==c instanceof Array&&window.console&&(c=[c]),new RadiantQ.RQ_ObservableCollection(c)),RadiantQ.FlexyGantt.TasksPositionTracker&&(this._tracker=new RadiantQ.FlexyGantt.TasksPositionTracker(this.options.FlexyGantt,c,{Property:this.options.TaskStartTime})))}else null!=this._tracker&&this._tracker.Dispose()},_ganttChart_ViewportTimeRangeChanged:function(a,
c){this.BrowseToCueLeft=this.options.GanttChart.GanttChart.scrollLeft();this.BrowseToCueRight=this.BrowseToCueLeft+this.options.GanttChart.GanttChart[0].clientWidth-30;this._updateBrowseToTaskCuesStates()},_updateBrowseToTaskCuesStates:function(){this.BrowseToTaskCueLeftVisibility=null!=this.options.TaskBarBrowseToCueRightTemplate&&null!=this._tracker&&this._tracker.AreTasksAvailableBefore(this.options.GanttChart.VisualStartTime)?"block":"none";this.BrowseToTaskCueRightVisibility=null!=this.options.TaskBarBrowseToCueLeftTemplate&&
null!=this._tracker&&this._tracker.AreTasksAvailableAfter(this.options.GanttChart.VisualEndTime)?"block":"none";this.BrowseToTaskCueLeft&&this.BrowseToTaskCueLeft.css({"margin-left":this.BrowseToCueLeft,display:this.BrowseToTaskCueLeftVisibility});this.BrowseToTaskCueRight&&("block"==this.BrowseToTaskCueLeftVisibility&&(this.BrowseToCueRight=this.BrowseToCueRight-this.BrowseToCueLeft-30),this.BrowseToTaskCueRight.css({"margin-left":this.BrowseToCueRight,display:this.BrowseToTaskCueRightVisibility}))},
UpdateItemForCue:function(a,c,d){null!=this._tracker&&(this._tracker.UpdateTimes(c,d),this._updateBrowseToTaskCuesStates())}})})(jQuery);
...
EnableDropAsChild:!1,OnTaskBarLoad:null},HeaderHeight:null,SelectedRowsDrag:new ObjectEvent("SelectedRowsDrag"),SelectedRowsDrop:new ObjectEvent("SelectedRowsDrop"),SelectedRowsDropped:new ObjectEvent("SelectedRowsDropped"),GanttType:null,IsGanttTable:null,_roundTimeEditsTo:null,RoundTimeEditsTo:function(a){if(void 0==a){if(this._roundTimeEditsTo)return this._roundTimeEditsTo;this._roundTimeEditsTo=RadiantQ.Gantt.RoundToOptions.None}else this._roundTimeEditsTo=a},_ganttChartIsLoaded:!1,GanttChartIsLoaded:function(a){if(void 0==
a){if(this._ganttChartIsLoaded)return this._ganttChartIsLoaded;this._ganttChartIsLoaded=!1}else this._ganttChartIsLoaded=a},_create:function(){this._validateOptions();this._roundTimeEditsTo=this.options.RoundTimeEditsTo?this.options.RoundTimeEditsTo:RadiantQ.Gantt.RoundToOptions.None;var a=this;this.GanttChartLoaded=new ObjectEvent("GanttChartLoaded");this._ganttChartIsLoaded=!1;this.IsGanttTable=null!=this.options.GanttTable;""===this.options.WorkTimeSchedule&&(this.options.WorkTimeSchedule=RadiantQ.Gantt.WorkTimeSchedule.Schedule8X5);
this.element.addClass("rq-ganttBase radiantq-ui-GanttBase");a=this;$(window).resize(function(){a.RefreshGanttHeight()});null==this.options.TimeScaleHeaders&&(this.options.TimeScaleHeaders=this.defaultTimeScaleHeaders());this.options.UseVirtualization&&(this.options.UseChartVirtualization=!0);this.initializeGanttBase();this.IsTableCreated=!1;this._layoutGanttControls();this.initTable();this.IsTableCreated=!0;this.UpdateDatasource(!0);this.initGanttChart()},RefreshGanttHeight:function(){if(!this.IsTableCreated||
...
HideGanttGrid:function(a){if(a){$($(".ui-layout-resizer",this.element)).css("display","none");a=$("#gantt_container_GanttChart",this.element);$(a).css("left","0px");$(a).css("width",parseInt($(a).width())+10+"px");var b=$("div.rq-gc-rowsParent",this.element),c=$("div.rq-gc-dependencysParent",this.element);b.css("width",this.GetGanttChart().data("GanttChart").options.ViewWidth+"px");b.css("overflow-y","auto");$(b).scroll(function(){0<c.length&&(c[0].scrollTop=b[0].scrollTop)})}},defaultTimeScaleHeaders:function(){var a=
new RadiantQ.Gantt.TimeScaleHeaderDefinition;a.Type=ns_gantt.TimeScaleType.Days;var b=new RadiantQ.Gantt.TimeScaleHeaderDefinition;b.Type=ns_gantt.TimeScaleType.Weeks;var c=new RadiantQ.Gantt.TimeScaleHeaderDefinitions;c.add(b);c.add(a);return c},_workTimeSchedule:null,WorkTimeSchedule:function(a){if(void 0==a)return this._workTimeSchedule;a!=this._workTimeSchedule&&(this._workTimeSchedule=a,this.options.WorkTimeSchedule=a,this.OnWorkTimeScheduleChanged())},UpdateChartHeight:function(){var a=$("div.ui-grid-body",
this.element);$("table.ui-grid-body-table",this.element);if(!$(this._getUniqueSelectorIdByID("TopDivContainer"),this.element).data("layout").state.west.isClosed){var b=$("div.rq-gc-rowsParent",this.element);$("table",b);this.options.UseChartVirtualization||b.css("height",a[0].clientHeight);b=$("div.rq-gc-dependencysParent",this.element);if(0<b.length){var c=Math.min(a.height(),a[0].clientHeight);b.css("height",c);a=$(".grid-body-actualContent",a).height();this.options.UseChartVirtualization?b.children().height(a):
b.children().css("height",a)}}},RefreshGanttWidth:function(){var a=$(this._getUniqueSelectorIdByID("TopDivContainer"),this.element),b=this.GetGanttChart(),c=$(".ui-layout-resizer",this.element),d=$(".ui-layout-west",this.element);a.data("layout").state.west.isClosed?b.width(a[0].clientWidth-c[0].clientWidth):b.width(a[0].clientWidth-(c[0].clientWidth+d[0].clientWidth))},OnWorkTimeScheduleChanged:function(){this.UpdateCalendarSettingInScaleHeaders()},UpdateCalendarSettingInScaleHeaders:function(){for(var a=
0;a<this.options.TimeScaleHeaders.length;a++)this.options.TimeScaleHeaders[a].WorkTimeSchedule=this.options.WorkTimeSchedule},ChartVerticalScrollSyncWithTable:function(){var a=this,b=$("div.ui-grid-body",this.element);$("table.ui-grid-body-table",this.element);var c=$("div.rq-gc-rowsParent",this.element);$("table.rq-gc-rowsParent-table",this.element);var d=$("div.rq-gc-dependencysParent",this.element);b.scroll(function(){this.options.UseChartVirtualization&&"FlexyGantt"!=this.GanttType||(0<d.length&&
d.css("height",c.height()),0<d.length&&(a.options.UseChartVirtualization?$(d[0].children).height(b[0].scrollHeight):$(d[0].children).css("height",$(c[0].children).css("height"))),c.scrollTop()!=b.scrollTop()&&(this.options.UseChartVirtualization||c.scrollTop(b.scrollTop()),0<d.length&&$(d).scrollTop(c.scrollTop())))}.bind(this))},_createUniqueID:function(a){return this.element[0].id+"_"+a},_validateOptions:function(){var a=this.options;window.console&&RadiantQ.CanUseDefineProperty&&(a.GanttTable&&
(a.GanttTable.length?"TABLE"==a.GanttTable[0].nodeName:"TABLE"==a.GanttTable.nodeName)||console.error("The GanttTable option is not set. Set it to a jQuery wrapper element refering a HTML table."),a.TaskTooltipTemplate&&"string"!=typeof a.TaskTooltipTemplate&&!1==(a.TaskTooltipTemplate.length?a.TaskTooltipTemplate[0]instanceof HTMLElement:a.TaskTooltipTemplate instanceof HTMLElement)&&console.error("TaskTooltipTemplate is not valid. Please make sure this references a valid HTML string that will be displayed in the tooltip. Or a jQuery wrapper element."),
...
jQuery._data(this.element[0],"events")[this.widgetName.toLowerCase()+"filtertasksbytimerange"]||this.options.FilterTasksByTimeRange){var b=this.GetGanttChartInstance();a=new RadiantQ.FlexyGantt.FilterTasksByTimeRangeEventArgs(a,b.options.ComputedStartTime,b.options.ComputedEndTime);this._trigger("FilterTasksByTimeRange",this,a);return a.FilteredList}return null},FlatItemsSource:null,UpdateDatasource:function(a){var b=this,c=new RadiantQ.FlexyGantt.HierarchyToList(this.options.DataSource,function(a){return b.options.resolverFunction.call(this,
a)},this.options);this.FlatItemsSource=c;this.FlatHierarchicalItemsList=this.FlatItemsSource.FlatHierarchicalItemsList;this.UpdateRowHeightBinding(c,!0);var d={};d.Source=c;d.canUpdateTable=a;this._trigger("FlatItemsSourceCreated",this,d);this.IsGanttTable&&(a?(a=this.PrepareGanttTable(),d=this.options.GanttTable,d.addClass("rq-FlexyTable"),this.options.CanUserReorderRows&&$("thead>tr",d).prepend($('<th style="width: 20px;" data-property="tracker"></th>')),d.FlexyTable({source:c.FlatItemsSource,RowHeight:this.options.RowHeight,
Parent:this,UseGridVirtualization:this.options.UseVirtualization,GanttTableRowLoadedCallBack:this.options.GanttTableRowLoadedCallBack,IsProjectGantt:!1,EnableAlternativeRowBackground:this.options.EnableAlternativeRowBackground,CanUserReorderRows:this.options.CanUserReorderRows}).FlexyTable("refresh"),d.parent().css("overflow-x","scroll"),$(this._getUniqueSelectorIdByID("Table"),this.element).empty().append(a),this.GanttTableElement=d,this.GanttTableElement.bind("flexytablerefresh",function(){b.UpdateChartHeight()}),
this.CanUpdateTable(this.CanUpdateTable()+1)):this.options.GanttTable.FlexyTable({GanttTableRowLoadedCallBack:this.options.GanttTableRowLoadedCallBack,RowHeight:this.options.RowHeight,EnableAlternativeRowBackground:this.options.EnableAlternativeRowBackground,source:c.FlatItemsSource}));void 0==c.FlatItemsSource&&(c.FlatItemsSource=null);this._setOption("FlatItemsSource",c.FlatItemsSource);c.dynamicResolver=this.options.dynamicResolverFunction;this.element.GanttRowselectable({Source:c.FlatItemsSource})},
UpdateRowHeightBinding:function(a,b){if(a&&a.FlatItemsSource){var c=this,d=a.FlatItemsSource,e=!1;null!=this.options.RowHeightBinding&&void 0!=this.options.RowHeightBinding.Property&&this.options.RowHeightBinding.Converter&&(e=!0);if(e&&b){for(e=0;e<d.length;e++)c.SubscribeChangeNotifications(d[e]);d.CollectionChanged.subscribe(function(a,b){"insert"==a.type&&c.SubscribeChangeNotifications(b.items[0]);"remove"==c.type&&c.UnsubscribeChangeNotifications(b.items[0])})}}},SubscribeChangeNotifications:function(a){a.PropertyChanged.subscribe(this.notifyChange,
...
this.options.FlatItemsSource;if(a)for(var b=0;b<a.length;b++)this.UpdateTableAndChartRowHeight(a[b],this.options.RowHeight);this.UpdateChartHeight()},tableHasScrollBar:!1,notifyChange:function(a,b){if(this.options.RowHeightBinding.Property==b.PropertyName){var c=this.options.RowHeightBinding.Converter.call(a,b.value);if(null!=c){this.UpdateTableAndChartRowHeight(a,c);this.UpdateChartHeight();var c=this.GetGanttTable(),d=c.uiGridBody[0];d.scrollHeight>d.clientHeight!=this.tableHasScrollBar&&c.refreshScrollBsrVisibility()}}},
updateGanttChart:function(a,b){var c=this.GetGanttChart();if(0!=c.length){switch(a){case "FlatItemsSource":return c.GanttChart("option","FlatItemsSource",b);case "TaskStartTimeProperty":return c.GanttChart("option","TaskStartTime",b);case "ParentTaskStartTimeProperty":return c.GanttChart("option","ParentTaskStartTime",b);case "TaskEndTimeProperty":return c.GanttChart("option","TaskEndTime",b);case "ParentTaskEndTimeProperty":return c.GanttChart("option","ParentTaskEndTime",b)}a in c.GanttChart("option")&&
(c.GanttChart("option",a)==b&&"BaseTimeScaleType"!=a||c.GanttChart("option",a,b))}},destroy:function(){$.radiantq.GanttBase.prototype.destroy.apply(this,arguments)},_setOption:function(a,b){$.radiantq.GanttBase.prototype._setOption.apply(this,arguments)}});function TimesChangingEventArgs(a,b,c,d,e){this.DataSource=a;this.StartTime=b;this.EndTime=c;this.Type=d;e&&(this.FlexyNodeData=e)}
...
EffortBinding:{Property:"Effort"},PredecessorIndicesBinding:{Property:"PredecessorIndices"},ProgressPercentBinding:{Property:"ProgressPercent"},DescriptionBinding:{Property:"Description"},ResourceItemsSource:null,ResourceNameBinding:null,ResourceIDBinding:null,ResourceScheduleBinding:null,AssignedResourcesBinding:{Property:"Resources"},CanShiftInProgressTasks:!0,GanttResources:null,PropertyChanged:new ObjectEvent("PropertyChanged"),LagStringUnitsInHours:1,CanInsertPropertyChangeTriggeringPropertiesInData:null,
TaskBarBackgroundTemplate:null,TaskBarAdornerTemplate:null,FilterActivites:null,AutoExpandNodes:!0,CustomProgressCalculation:null,IsTaskReadOnlyBinding:null,CanUserReorderRows:!1},SelectedItems:null,_selectedItem:null,SelectedActivities:null,SelectedActivity:null,ActivityViews:null,Model:null,PropertyChanged:null,TaskContextMenu:null,TableContextMenu:null,DependencyContextMenu:null,RedrawChartRows:null,RedrawChartRow:null,GanttTaskItemBarCollection:[],ActivityTimeChanged:new ObjectEvent("ActivityTimeChanged"),
GetGanttTable:function(){return this.options.GanttTable.data("GanttTable")},FilterActivites:null,Filter:function(){null!=this.Model&&(this.Model.Filter(this.options.FilterActivites),this.UpdateViews(!1))},ResetFilters:function(){null!=this.Model&&(this.Model.Filter(null),this.UpdateViews(!1))},updateTable:function(){if(2==this.CanUpdateTable()){this.UpdateHeight();var a=this;$(".grid-body-actualContent",this.element);this.element.GanttRowselectable({SelectionMode:this.options.SelectionMode,IsFlexyGantt:!1,
selectedChange:function(b,c){a.SelectedActivities=[];a.SelectedItems=$.makeArray(a.element.data("GanttRowselectable").SelectedItems());1<a.SelectedItems.length&&(a.SelectedItems=a.SelectedItems.sort(function(b,c){return b.$tableRow&&b.$tableRow.length&&c.$tableRow&&c.$tableRow.length?a.options.UseVirtualization?b.$tableRow[0]._displayIndex-c.$tableRow[0]._displayIndex:b.$tableRow[0].rowIndex-c.$tableRow[0].rowIndex:0}));for(var d=0;d<a.SelectedItems.length;d++)a.SelectedActivities.push(a.SelectedItems[d].Activity);
...
b.Data);this.ApplyTooltipSettings(this.ParentBar,b.Data);this.ApplyTooltipSettings(this.MileStoneBar,b.Data);this._loadAdornerAndBgTemplate();this.GanttControl.RedrawChartRow=this.RedrawTaskBar;this.taskStartAndEndTime={Name:this.options.ActivityView.Activity.ActivityName,OriginalStart:this.Activity.StartTime,OriginalEnd:this.Activity.EndTime,originalWidth:this.TaskBarRectangle.width(),originalLeft:this.TaskBarRectangle.css("margin-left"),ProgressEndTime:null,ProposedEnd:null,ProposedStart:null};
this.IsTemplateApplied=!0;a||this._OnRecomputeLocation();b.GanttChart.element.bind("ganttchartrefreshui.GanttControlTaskBarRefreshUI",function(a,b){"ProjectGantt"==b.options.GanttType&&(this.options.WorkTimeSchedule=b.options.WorkTimeSchedule,this._OnRecomputeLocation(),this._removeTooltip(this.TaskBarRectangle),this._removeTooltip(this.ParentBar),this._removeTooltip(this.MileStoneBar))}.bind(this));this._GanttChart_ViewportTimeRangeChanged(this,null);this.GanttChart._dirtyTaskItemControls&&(this.GanttChart._dirtyTaskItemControls.push(this),
this.GanttChart._diryTaskItemByActs[this.Activity.id]=this);this.options.IsPrinting||(this.initValuesFromOptions(),this.UpdateThumbsReadOnlyStates())},RedrawTaskBar:function(a){this._destroy();this._create(!0);this.KnockoutObject&&ko.applyBindingsToDescendants(this.KnockoutObject,this.element[0])},KnockoutObject:null,ViewStartTime:function(){return this.GanttChart.options.ComputedStartTime},ViewEndTime:function(){return this.GanttChart.options.ComputedEndTime},ViewWidth:function(){return this.GanttChart.options.ViewWidth},
_OnRecomputeLocation:function(){if(null!=this.ActivityView&&!0!=this.StartTime().isGreaterThan(this.EndTime())&&!1!=this.IsTemplateApplied){var b=TimeComputingUtils.ConvertToUnitsOfBaseScaleType(this.GanttChart.options.BaseTimeScaleType,this.ViewStartTime(),this.StartTime(),this.GanttChart.options.WorkTimeSchedule)*this.GanttChart.options.BaseTimeUnitWidth,d=TimeComputingUtils.ConvertToUnitsOfBaseScaleType(this.GanttChart.options.BaseTimeScaleType,this.StartTime(),this.EndTime(),this.GanttChart.options.WorkTimeSchedule)*
this.GanttChart.options.BaseTimeUnitWidth;this.OriginalLeft=b;this.OriginalWidth=d;null!=this.ParentBar&&this.ParentBar.css("display","none");null!=this.MileStoneBar&&this.MileStoneBar.css("display","none");null!=this.TaskBarRectangle&&this.TaskBarRectangle.css("display","none");if(this.IsParent()||this.IsMilestone()){this.CanvasLeft=b-7;if(this.IsParent()){25>d?this.ParentBar.css("width","45px"):this.ParentBar.css("width",d+20+"px");this.ParentBar.css({"margin-left":b-10+"px","margin-top":"2px"});
this.BarPolygon=this.ParentBar;this.BarWidth=d;this.OriginalCompletedWidth=this.CompletedWidth=0;this.ParentBar&&this.element.append(this.ParentBar);var e=a("div.label",this.ParentBar);0==e.length&&(e=a("div.rq-gc-taskbar-label",this.ParentBar));this.ParentBar&&0<e.length&&e.css("margin-left","30px")}else{this.MileStoneBar.css("width","17px");var f=this.MileStoneBar.outerWidth();this.MileStoneBar.css("margin-left",b-f/2-1+"px");this.MileStoneBar.css("margin-top","4px");this.BarPolygon=this.MileStoneBar;
this.BarWidth=14;this.OriginalCompletedWidth=this.CompletedWidth=0;this.MileStoneBar&&this.element.append(this.MileStoneBar)}null!=this.BarPolygon&&this.BarPolygon.css("display","block");null!=this.TaskBarRectangle&&this.TaskBarRectangle.css("display","none");null!=this.ProgressPercentResizeThumb&&this.ProgressPercentResizeThumb.hide()}else this.CanvasLeft=b,this.BarWidth=d,null!=this.ParentBar&&this.ParentBar.css("display","none"),null!=this.MileStoneBar&&this.MileStoneBar.css("display","none"),
null!=this.TaskBarRectangle&&this.TaskBarRectangle.css("display","block"),this._UpdateProgressBarPosition(b);this.CanvasRight=this.CanvasLeft+this.BarWidth;this.TaskBarRectangle.css("width",d+"px");this.TaskBarRectangle.css("margin-left",b+"px");this.TaskBarRectangle.css("margin-top","3px");this.ProgressBarRectangle.width(this.CompletedWidth-1);this.ProgressBarRectangle.css("border-width","1px");this.ProgressBarRectangle.css("border-style","solid");0==this.CompletedWidth&&this.ProgressBarRectangle.css("border-width",
"0px");b=this.TaskBarRectangle.height();this.ProgressBarRectangle.css("margin-top",b/2-2.5+"px");this._loadAdornerAndBgTemplate();this._drawVerticalLines(f);this._updateTaskBarLabel();this._UpdateBrowseToTaskCuesStates();f=this.GanttChart.options.OnTaskBarLoad;null!=f&&"function"==typeof f&&f.call(this.TaskBarRectangle[0],this)}},_drawVerticalLines:function(a){var b=this.IsMilestone(),e=this.IsParent(),f=this.element,f=this.TaskBarRectangle;!0==e&&(f=this.ParentBar);!0==b&&!1==e&&(b=!0,f=this.MileStoneBar);
if(null!=f){var g=f.find("div.rq-gc-start-verticalLine"),h=f.find("div.rq-gc-end-verticalLine");if(0!=g.length||0!=h.length){var k=f.closest("tr");if(k.length){var l=parseInt(f.css("margin-top"));f.height();f=f.width();k=k[0].offsetTop;l={height:k+l+"px","margin-left":"0px","margin-top":-(k+l)+"px"};taskbarwidth=f;!0==b&&!1==e&&(taskbarwidth=a/2,l["margin-left"]=taskbarwidth+"px");0!=g.length&&g.css(l);0!=h.length&&(l["margin-left"]=taskbarwidth+"px",h.css(l));a=this.options.GanttChart.options.TimeIndicatorLineOption;
(a&ns_gantt.TimeIndicatorLines.Always)!=ns_gantt.TimeIndicatorLines.Always||(a&ns_gantt.TimeIndicatorLines.OnResize)==ns_gantt.TimeIndicatorLines.OnResize?(g.hide(),h.hide()):(g.show(),h.show())}}}},_actView_PropertyChanged:function(a,b){"IsReadOnly"==b.PropertyName&&this.ReadOnlyStateChangedCallback(a,b)},UpdateUI:function(){var a=this.GanttChart._dirtyTaskItemControls;this.GanttChart._dirtyTaskItemControls=[];this.GanttChart._diryTaskItemByActs={};for(var b=0;b<a.length;b++)a[b]._OnRecomputeLocation();
this.GanttChart._dirtyTasksTimer=null;this.GanttChart._dirtyTaskItemControls=[]},_isActivityPropertyChanged:!1,_$parentMiddleBar:null,_activity_PropertyChanged:function(b,d){this._isActivityPropertyChanged=!0;void 0===this.GanttChart._dirtyTaskItemControls&&(this.GanttChart._dirtyTasksTimer=null,this.GanttChart._dirtyTaskItemControls=[],this.GanttChart._diryTaskItemByActs={});null==this._$parentMiddleBar&&(this._$parentMiddleBar=a(".rq-gc-parentBar-middle",this.ParentBar));0==this._$parentMiddleBar.length&&
(this._$parentMiddleBar=a(".parentMiddleBar-style",this.ParentBar));"IsExpanded"==d.PropertyName&&(!1==d.value?this._$parentMiddleBar.addClass("rq-gc-Parentbar-collapsed"):this._$parentMiddleBar.removeClass("rq-gc-Parentbar-collapsed"));var e=this.Activity.ID;void 0===this.GanttChart._diryTaskItemByActs[e]&&this.GanttChart._dirtyTaskItemControls.push(this);this.GanttChart._diryTaskItemByActs[e]=this;e=this.GanttChart._dirtyTasksTimer;null!=e&&clearTimeout(e);this.GanttChart._dirtyTasksTimer=setTimeout(function(){this.UpdateUI()}.bind(this),
0)},_AdjustOrigionalLeftAndWidth:function(){if(0>this.OriginalLeft+this.OriginalWidth||this.OriginalLeft>this.ViewWidth())left=-10,width=0;else{var a=this.GanttChart.GetBarRenderStartTime(this.StartTime()),b=this.GanttChart.GetBarRenderEndTime(this.EndTime());!1!=a.equals(this.StartTime())&&!1!=b.equals(this.EndTime())||!a.isLessThan(b)||(width=TimeComputingUtils.ConvertToUnitsOfBaseScaleType(this.GanttChart.options.BaseTimeScaleType,a,b,this.GanttChart.options.WorkTimeSchedule)*this.GanttChart.options.BaseTimeUnitWidth,
left=TimeComputingUtils.ConvertToUnitsOfBaseScaleType(this.GanttChart.options.BaseTimeScaleType,this.ViewStartTime(),a,this.GanttChart.options.WorkTimeSchedule)*this.GanttChart.options.BaseTimeUnitWidth)}},_UpdateProgressBarPosition:function(b){var d=this.OriginalWidth*this.ProgressPercent()/100;0==this.BarWidth?this.OriginalCompletedWidth=this.CompletedWidth=0:0>d?this.OriginalCompletedWidth=this.CompletedWidth=0:(this.OriginalCompletedWidth=d,d-=b-this.OriginalLeft,0>d&&(d=0),d>this.BarWidth&&(d=
this.BarWidth),this.CompletedWidth=d);this.ProgressPercentResizeThumb=a("div.rq-gc-progressbar-resizer",this.element);0==this.ProgressPercentResizeThumb.length&&(this.ProgressPercentResizeThumb=a("div.ui-progress-resizer",this.element));this.ProgressPercentResizeThumb.mouseover(this.TaskBarMouseHover.bind(this));this.ProgressPercentResizeThumb.mouseleave(this.TaskBarMouseLeave.bind(this));null!=this.ProgressPercentResizeThumb&&(10<this.BarWidth?(this.ProgressPercentResizeThumb.show(),this.ProgressPercentResizeThumb.css("margin-left",
this.CanvasLeft+this.CompletedWidth),this.ProgressPercentResizeThumb.css("height",a(this.TaskBarRectangle).css("height"))):this.ProgressPercentResizeThumb.hide())},_updateTaskBarLabel:function(){var b=this.options,d=a("div.rq-gc-taskbar-label",this.TaskBarRectangle);0==d.length&&(d=a("div.label",this.TaskBarRectangle));this.LabelTmpl&&!this.KnockoutObject&&(b=a.tmpl(this.LabelTmpl,b.ActivityView.Activity),0<b.length&&b.text()&&(b.text(),b.css("margin-left",this.TaskBarRectangle.width()+12+"px")),
d.replaceWith(b));this.TaskBarRectangle&&0<d.length&&d.css("margin-left",this.TaskBarRectangle.width()+12+"px")},UpdateResourceText:function(b){if(0<this.Activity._assignments.length){var d=a("div#GanttTaskBarLabel",this.TaskBarRectangle);!0==this.IsParent()&&(d=a("div#GanttTaskBarLabel",this.ParentBar));if(d.length){var e=RadiantQ.Gantt.ValueConverters.ConverterUtils.GetResourcesText(this.Activity._assignments,!1);d[0].innerHTML=e;d[0].style.fontSize="12px";!1==this.ActivityView.IsParent?d.css("margin-right",
-(12*d[0].innerHTML.length/2+5)+"px"):d.css("margin-left","30px")}}!0==b&&0==this.Activity._assignments.length&&(a("div#GanttTaskBarLabel",this.TaskBarRectangle).html(""),a("div#GanttTaskBarLabel",this.ParentBar).html(""))},_listenForShiftAndResizeTracker:function(){!1!=this.options.IsPrinting||this.IsReadOnly||this.TaskReadOnly||(this.TaskBarRectangle.ganttShiftTracker(this,this.DragEnd),this.TaskBarRectangle.ganttResizeTracker(this,this.ResizeEnd),this.ParentBar.ganttShiftTracker(this,this.DragEnd),
this.MileStoneBar.ganttShiftTracker(this,this.DragEnd),this.TaskBarRectangle.css("cursor","move"))},DragEnd:function(a,b){if(!this.StartTime().equals(this.taskStartAndEndTime.ProposedStart)||!this.EndTime().equals(this.taskStartAndEndTime.ProposedEnd))if(this.Activity.PreferredStartTime=this.taskStartAndEndTime.ProposedStart,this.Activity.StartTime=this.taskStartAndEndTime.ProposedStart,this.ProgressEndTime(this.Activity.ProgressEndTime),0<this.GanttControl.ActivityTimeChanged.fn.length){var e=new TimesChangingEventArgs(this.Activity,
this.taskStartAndEndTime.OriginalStart,this.taskStartAndEndTime.OriginalEnd,"DragEnd");this.GanttControl.ActivityTimeChanged.raise(this,e)}this._isActivityPropertyChanged=!1;this.TaskBarRectangle.removeClass("rq-taskbar-shadow")},ResizeEnd:function(a,b,e){b.forProgressBar.isTrue||(this.Activity.PreferredStartTime=this.Activity.StartTime,this.Activity.EndTime=this.taskStartAndEndTime.OriginalEnd,0<this.GanttControl.ActivityTimeChanged.fn.length&&(a=new TimesChangingEventArgs(this.Activity,this.taskStartAndEndTime.OriginalStart,
this.taskStartAndEndTime.OriginalEnd,"ResizeEnd"),this.GanttControl.ActivityTimeChanged.raise(this,a)));this._isActivityPropertyChanged=!1;this.TaskBarRectangle.removeClass("rq-taskbar-shadow")},_listenForTouchTap:function(){this.TaskBarRectangle[0].addEventListener("touchstart",this._onTouchstart.bind(this),!1);this.TaskBarRectangle[0].addEventListener("touchend",this._onTouchend.bind(this),!1);this.TaskBarRectangle[0].addEventListener("MSPointerDown",this._onTouchstart.bind(this),!1);this.TaskBarRectangle[0].addEventListener("MSPointerUp",
this._onTouchend.bind(this),!1)},tapDownX:null,tapDownY:null,_onTouchstart:function(a){a=a.touches?a.touches[0]:a;this.tapDownX=a.clientX;this.tapDownY=a.clientY},_onTouchend:function(b){var d=b.changedTouches?b.changedTouches[0]:b;this.tapDownX==d.clientX&&this.tapDownY==d.clientY&&"mouse"!=b.pointerType&&4!=b.pointerType&&a(this.TaskBarRectangle).contextMenu({x:d.clientX,y:d.clientY})},_listenForMouseEnterAndLeave:function(){this.TaskBarRectangle.mouseover(this.TaskBarMouseHover.bind(this));this.ParentBar.mouseover(this.TaskBarMouseHover.bind(this));
this.MileStoneBar.mouseover(this.TaskBarMouseHover.bind(this));this.TaskBarRectangle.mouseleave(this.TaskBarMouseLeave.bind(this));this.ParentBar.mouseleave(this.TaskBarMouseLeave.bind(this));this.MileStoneBar.mouseleave(this.TaskBarMouseLeave.bind(this))},TaskBarMouseHover:function(a,b){this.GanttChart.TaskOnMouseHover=this.ActivityView;var e=this.IsMilestone(),f=this.IsParent(),g=this.TaskBarRectangle;!0==f&&(g=this.ParentBar);!0==e&&!1==f&&(g=this.MileStoneBar);!1==e&&!1==f&&g.addClass("rq-taskbar-shadow");
this.GanttChart.options.TimeIndicatorLineOption==ns_gantt.TimeIndicatorLines.OnHover&&(g.find("div.rq-gc-start-verticalLine").show(),g.find("div.rq-gc-end-verticalLine").show())},TaskBarMouseLeave:function(a,b){var e=this.IsMilestone(),f=this.IsParent(),g=this.TaskBarRectangle;!0==f&&(g=this.ParentBar);!0==e&&!1==f&&(g=this.MileStoneBar);!1==e&&!1==f&&g.removeClass("rq-taskbar-shadow");this.GanttChart.options.TimeIndicatorLineOption==ns_gantt.TimeIndicatorLines.OnHover&&(g.find("div.rq-gc-start-verticalLine").hide(),
g.find("div.rq-gc-end-verticalLine").hide());this.GanttChart.TaskOnMouseHover=null},_updateElementsFromTemplate:function(){var a=this.TaskBarRectangle,b=this.MileStoneBar,e=this.ParentBar;this._renderElementsFromTemplate();a.replaceWith(this.TaskBarRectangle);b.replaceWith(this.MileStoneBar);e.replaceWith(this.ParentBar)},_renderElementsFromTemplate:function(){var b=this.options;b.TaskTemplate?(b.TaskTemplate=b.TaskTemplate.replace(/RQDataContext/g,["Task"+b.RowCount]),this.TaskBarRectangle=a.tmpl(this.options.TaskTemplate,
