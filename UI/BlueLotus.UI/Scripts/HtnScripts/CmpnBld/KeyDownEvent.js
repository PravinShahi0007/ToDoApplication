...
function CallAllKeyDownHandlingForNumericBox() {
    ...
    //CmpnBldKeyDownHandlingForNumericBox("HdrSec1_NmricAnlQty_Val");
    ...
    CmpnBldKeyDownHandlingForNumericBox("HdrSec1_NmricLiNo_Val");
}
...
$("#HdrSec1_NmricAnlQty_Val").keydown(function (event) {
    var keycode = (event.keyCode ? event.keyCode : event.which);
    if (keycode == '13') {
        $("#HdrSec1_CmbItm_Cd").data("kendoComboBox").input.focus();
        event.preventDefault();
