...
namespace BlueLotus.UI.ApiOperations
{
    public partial class ApiOperation
    {
        ...
        internal List<DailyToDoModel> ToDoPrcsDet_SelectWeb(string EnvironmentName, int Cky, int UsrKy, int PrjKy, int LeadAdrKy, int CurAdrKy,int ObjKy,int PrcsStpKy,int PrtyKy, int PrcsObjKy, int AprStsKy)
        {
