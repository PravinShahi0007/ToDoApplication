...
function changeItemRalatedTotalCommon(calledFrom) {
    ...
    if ((Qty == 0 || Qty == "" || Qty == null || Qty == undefined) && (viewBag.OurCd != "StkCount")) {
        ...
        var NBTAmt = (NBTPer / (100 - NBTPer)) * (SubTotal - DisAmt);
...
function SetChangedItemDetails() {
    ...
    var ItmNm = '';
    if (ItmCd.length <= 0) {
        ItmCd = $("#HdrSec5_CmbItm_Cd").data("kendoComboBox").text();
        ItmNm = $("#HdrSec5_CmbItm_Nm").data("kendoComboBox").text();
    }
    ...
    var TaskUnitKy = $("#HdrSec8_TaskUnitKy_Cd").data('kendoComboBox').value();
    var TaskUnit = $("#HdrSec8_TaskUnitKy_Cd").data('kendoComboBox').text();
    ...
    var CTaskQty = $("#HdrSec8_TaskQty_Val").kendoNumericTextBox({
        spinners: false,
        change: function () {
            var value = this.value();
        }
    });
    var TaskQty = CTaskQty.val();
    if (isNaN(TaskQty)) {
        TaskQty = 0;
    }

    var CAmt1 = $("#HdrSec8_Amt1_Val").kendoNumericTextBox({
        spinners: false,
        change: function () {
            var value = this.value();
        }
    ...
    var CAmt2 = $("#HdrSec8_Amt2_Val").kendoNumericTextBox({
        spinners: false,
        change: function () {
            var value = this.value();
        }
    ...
    var CAmt3 = $("#HdrSec8_Amt3_Val").kendoNumericTextBox({
        spinners: false,
        change: function () {
            var value = this.value();
        }
    ...
    var CAmt4 = $("#HdrSec8_Amt4_Val").kendoNumericTextBox({
        spinners: false,
        change: function () {
            var value = this.value();
        }
    ...
    var CAmt5 = $("#HdrSec8_Amt5_Val").kendoNumericTextBox({
        spinners: false,
        change: function () {
            var value = this.value();
        }
    ...
    var CAmt6 = $("#HdrSec8_Amt6_Val").kendoNumericTextBox({
        spinners: false,
        change: function () {
            var value = this.value();
        }
    ...
    firstItem.set("Amt1", Amt1);
    firstItem.set("Amt2", Amt2);
    firstItem.set("Amt3", Amt3);
    firstItem.set("Amt4", Amt4);
    firstItem.set("Amt5", Amt5);
    firstItem.set("Amt6", Amt6);
    firstItem.set("TaskQty", TaskQty);
    firstItem.set("TaskUnitKy", TaskUnitKy);
    firstItem.set("TaskUnit", TaskUnit);
...
dblclickCreation = function (e) {
    ...
    if ((ItmKy != "" || ItmKy != undefined || ItmKy != null) && (ItmKy != "?")) {
        ...
        var DetailAmt1 = selectedItem.Amt1;
        var DetailAmt2 = selectedItem.Amt2;
        var DetailAmt3 = selectedItem.Amt3;
        var DetailAmt4 = selectedItem.Amt4;
        var DetailAmt5 = selectedItem.Amt5;
        var DetailAmt6 = selectedItem.Amt6;
        var TaskQty = selectedItem.TaskQty;
        var TaskUnitKy = selectedItem.TaskUnitKy;
        var TaskUnit = selectedItem.TaskUnit;

        if (isNaN(DetailAmt1)) {
            $("#HdrSec8_Amt1_Val").data("kendoNumericTextBox").value(0);
        } else {
            $("#HdrSec8_Amt1_Val").data("kendoNumericTextBox").value(DetailAmt1);
        }

        if (isNaN(DetailAmt2)) {
            $("#HdrSec8_Amt2_Val").data("kendoNumericTextBox").value(0);
        } else {
            $("#HdrSec8_Amt2_Val").data("kendoNumericTextBox").value(DetailAmt2);
        }

        if (isNaN(DetailAmt3)) {
            $("#HdrSec8_Amt3_Val").data("kendoNumericTextBox").value(0);
        } else {
            $("#HdrSec8_Amt3_Val").data("kendoNumericTextBox").value(DetailAmt3);
        }

        if (isNaN(DetailAmt4)) {
            $("#HdrSec8_Amt4_Val").data("kendoNumericTextBox").value(0);
        } else {
            $("#HdrSec8_Amt4_Val").data("kendoNumericTextBox").value(DetailAmt4);
        }

        if (isNaN(DetailAmt5)) {
            $("#HdrSec8_Amt5_Val").data("kendoNumericTextBox").value(0);
        } else {
            $("#HdrSec8_Amt5_Val").data("kendoNumericTextBox").value(DetailAmt5);
        }

        if (isNaN(DetailAmt6)) {
            $("#HdrSec8_Amt6_Val").data("kendoNumericTextBox").value(0);
        } else {
            $("#HdrSec8_Amt6_Val").data("kendoNumericTextBox").value(DetailAmt6);
        }

        if (isNaN(TaskQty)) {
            $("#HdrSec8_TaskQty_Val").data("kendoNumericTextBox").value(0);
        } else {
            $("#HdrSec8_TaskQty_Val").data("kendoNumericTextBox").value(TaskQty);
        }
        ...
        $("#HdrSec8_TaskUnitKy_Cd").data("kendoComboBox").value(TaskUnitKy);
