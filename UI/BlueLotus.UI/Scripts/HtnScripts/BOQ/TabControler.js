...
//$("#BOQ_Main_TabStrip").on("click", "li.k-state-default", function (e) {
//    BOQDetSettingsTab();
//});

//function BOQDetSettingsTab() {

//}

function onSelect_BOQ_Main_TabStrip(e) {
    //ClearDataEntryFileds();//to clear all field
    //var tabIndx = -1;
    ...
    //    if (globalVariable.OrdDetKy < 11) {
    //        alert("Select an BOQ Det Item ...!");
