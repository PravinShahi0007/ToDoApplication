...
function DocReadyCus() {
    ...
    $("#HdrSec5_NmricQty_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec8_Amt1_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec8_Amt2_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec8_Amt3_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec8_Amt4_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec8_Amt5_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec8_Amt6_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec8_TaskQty_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    //$("#HdrSec8_TaskUnitKy_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
    //    var input = $(this);
    //    setTimeout(function () {
    //        input.select();
    //    });
...
$("#HdrSec9_Amt1_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec9_Amt2_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec9_Amt3_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec9_Amt4_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec9_Amt5_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec9_Amt6_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec9_ComisPer_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
    ...
    $("#HdrSec9_RepComisPer_Val").kendoNumericTextBox({ min: 0, spinners: false }).focus(function () {
        var input = $(this);
        setTimeout(function () {
            input.select();
        });
...
function LoadTaskCombo(PrjKy) {
    ...
    $("#HdrSec5_CmbTask_Cd").kendoComboBox({
        ...
        change: function (e) {
            ...
            //if (validate) LoadTaskUnitCombo(TaskKy);
        },
        filter: "startswith",
        suggest: true,
...
function LoadTaskUnitCombo(TaskKy) {

    $("#HdrSec8_TaskUnitKy_Cd").kendoComboBox({
        dataValueField: "UnitKy",
        dataTextField: "Unit",
        dataSource: UnitDatasource(TaskKy),
        change: function (e) {
            var validate = ComboValidations("HdrSec8_TaskUnitKy_Cd");
        },
        filter: "startswith",
        suggest: true,
        placeholder: "Select a Unit"
    ...
    $("#HdrSec8_TaskUnitKy_Cd").data("kendoComboBox").input.keypress(function (e) {
        var keycode = (e.keyCode ? e.keyCode : e.which);
        if (keycode == '13') {
            var LiNo = FormGlblData.Detail_Editing_LiNo;
            if (LiNo == 0 || LiNo == null || LiNo == undefined) {
            ...
            schema: {
                model: {
                    ...
                    fields:
                    {
                        ...
                        Amt3: { editable: true, nullable: false, type: "number" },
                        Amt4: { editable: true, nullable: false, type: "number" },
                        Amt5: { editable: true, nullable: false, type: "number" },
                        Amt6: { editable: true, nullable: false, type: "number" },
                        TaskQty: { editable: true, nullable: false, type: "number" },
                        TaskUnitKy: { editable: true, nullable: false, type: "number" },
                        TaskUnit: { editable: true, nullable: false },
...
function LoadGridView1(PrjKy) {
    ...
    var columnsDefine = [
        ...
        {
            field: "Amt1", title: "Amt1", width: "150px", format: "{0:N2}",
            editor: function (container, options) {
                var model = options.model;
            }
        },
        {
            field: "Amt2", title: "Amt2", width: "150px", format: "{0:N2}",
            editor: function (container, options) {
                var model = options.model;
            }
        },
        {
            field: "Amt3", title: "Amt3", width: "150px", format: "{0:N2}",
            editor: function (container, options) {
                var model = options.model;
            }
        },
        {
            field: "Amt4", title: "Amt4", width: "150px", format: "{0:N2}",
            editor: function (container, options) {
                var model = options.model;
            }
        },
        {
            field: "Amt5", title: "Amt5", width: "150px", format: "{0:N2}",
            editor: function (container, options) {
                var model = options.model;
            }
        },
        {
            field: "Amt6", title: "Amt6", width: "150px", format: "{0:N2}",
            editor: function (container, options) {
                var model = options.model;
            }
        },
        {
            field: "TaskQty", title: "TaskQty", width: "150px", format: "{0:N2}",
            editor: function (container, options) {
                var model = options.model;
            }
        },
        {
            field: "TaskUnitKy", title: "TaskUnitKy", width: "100px", 
            editor: function (container, options) {
                var model = options.model;
            }
        },
        {
            field: "TaskUnit", title: "TaskUnit", width: "100px",
            editor: function (container, options) {
                var model = options.model;
            }
        },
...
function ComClearWithOutDefaultSetting(setDefault, whereFrom) {
    ...
    //$("#HdrSec4_InptSumAmt5_Val").data("kendoNumericTextBox").value(null);
    //$("#HdrSec4_InptSumAmt6_Val").data("kendoNumericTextBox").value(null);


    $("#HdrSec3_NmricExRate_Val").data("kendoNumericTextBox").value(1);

    $("#HdrSec8_Amt1_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec8_Amt2_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec8_Amt3_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec8_Amt4_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec8_Amt5_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec8_Amt6_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec8_TaskQty_Val").data("kendoNumericTextBox").value(null);

    $("#HdrSec9_Amt1_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec9_Amt2_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec9_Amt3_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec9_Amt4_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec9_Amt5_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec9_Amt6_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec9_ComisPer_Val").data("kendoNumericTextBox").value(null);
    $("#HdrSec9_RepComisPer_Val").data("kendoNumericTextBox").value(null);
