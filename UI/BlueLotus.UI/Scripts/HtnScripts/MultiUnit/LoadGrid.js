function LoadMultiUnitGrid() {
    ...
    var cusColumns = [
        ...
        {
            field: "isServiceUnit", title: "isServiceUnit", width: '100px',
            template: '<input type="checkbox"  #= isServiceUnit? "checked=checked" : "" # class="isServiceUnit" ></input>'
        },
        {
            field: "isDefaultServiceUnit1", title: "isDefaultServiceUnit1", width: '100px',
            template: '<input type="checkbox"  #= isDefaultServiceUnit1? "checked=checked" : "" # class="isDefaultServiceUnit1" ></input>'
        },
        {
        ...
        schema: {
            model: {
                ...
                fields:
                {
                    ...
                    isServiceUnit: { editable: true, nullable: false, type: "boolean" },
                    isDefaultServiceUnit1: { editable: true, nullable: false, type: "boolean" },
...
$('#MultiUnitGrid').on('click', '.isServiceUnit', function () {
    var checked = $(this).is(':checked');
    var grid = $('#MultiUnitGrid').data().kendoGrid;
    var dataItem = grid.dataItem($(this).closest('tr'));
    if (dataItem != undefined) {
        dataItem.set('isServiceUnit ', checked);
    }
});
$('#MultiUnitGrid').on('click', '.isDefaultServiceUnit1', function () {
    var checked = $(this).is(':checked');
    var grid = $('#MultiUnitGrid').data().kendoGrid;
    var dataItem = grid.dataItem($(this).closest('tr'));
    if (dataItem != undefined) {
        dataItem.set('isDefaultServiceUnit1 ', checked);
    }
});
