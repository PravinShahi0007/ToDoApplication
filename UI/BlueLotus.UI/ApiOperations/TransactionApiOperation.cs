...
namespace BlueLotus.UI.ApiOperations
{
    public partial class ApiOperation
    {
        ...
        public List<UnitModel> GetItemMultiUnits(string EnvironmentName, int ItmKy, int cky, int UsrKy,string trnTypKy)
        {
            HttpResponseMessage response = httpClient.GetAsync(this.GetUriWithEnvironment(EnvironmentName, "api/Transaction/GetItemMultiUnits?ItmKy=" + ItmKy + "&CKy=" + cky+ "&trnTypKy=" + trnTypKy + "&UsrKy=" + UsrKy + "")).Result;
