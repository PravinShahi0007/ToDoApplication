...
function ClearFunction() {
    ...
    //globalVariable.PrcsSchDetKy = 1;
    //globalVariable.PrcsDetKy = 1;
    ...
    GetGridDetailFrmItmCmpnDet(globalVariable.PrcsSchDetKy);
...
function DeepClearDetailsFunction() {
    ...
    $("#HdrSec1_NmricPlnQty_Val").data("kendoNumericTextBox").value(0);
