        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((!Page.IsPostBack))
            {
                try
                {
                    ...
                    string OrdKy = Session["PurchaseRequisitionOrdKy"].ToString();
                    string CKy = Session["CKy"].ToString();

                    List<ReportParameter> paramList = new List<ReportParameter>();

                    paramList.Add(new ReportParameter("OrdKy", OrdKy));
                    paramList.Add(new ReportParameter("CKy", CKy));
                    ...
                    MyReportViewer.ServerReport.ReportPath = WebConfigurationManager.AppSettings["ReportpathforPR"];
