...
namespace BlueLotus.UI.Reports.Purchase
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((!Page.IsPostBack))
            {
                try
                {
                    ...
                    string OrdKy = Session["PurchaseOrderOrdKy"].ToString();
                    ...
                    paramList.Add(new ReportParameter("ServerName", ConfigurationManager.AppSettings["ReportServerName"].ToString()));
                    paramList.Add(new ReportParameter("EnvironmentName", HTNSession.Environment));
