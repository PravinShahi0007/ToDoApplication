...
namespace BlueLotus.UI.ApiOperations
{
    public partial class ApiOperation
    {
        ...
        public List<GetItmRateDisTax> GetItmRateDisTax(string EnvironmentName, int CKy, int ObjKy, int UsrKy, string OrdItemDet)
        {
        ...
        public List<UnitModelForOrder> GetMultiUnitsForOrder(string EnvironmentName, int UsrKy, int ItmKy,string OrdTypKy,int Cky)
        {
        ...
        //public bool ChkOrdEditValidation(int CKy, int UsrKy, int OrdKy,string EnvironmentName)
        //{
        //    string actionUri = "ChkOrdHdrEditValidation";
        //    Dictionary<string, object> paramDictionary = new Dictionary<string, object>();
        //    paramDictionary.Add("CKy", CKy);
        //    paramDictionary.Add("UsrKy", UsrKy);
        //    paramDictionary.Add("OrdKy", OrdKy);
        ...
        //public bool OrdHdr_UnlockWeb(int CKy, int UsrKy, int OrdKy, string EnvironmentName)
        //{
        //    string actionUri = "OrdHdr_UnlockWeb";
        //    Dictionary<string, object> paramDictionary = new Dictionary<string, object>();
        //    paramDictionary.Add("CKy", CKy);
        //    paramDictionary.Add("UsrKy", UsrKy);
        //    paramDictionary.Add("OrdKy", OrdKy);
