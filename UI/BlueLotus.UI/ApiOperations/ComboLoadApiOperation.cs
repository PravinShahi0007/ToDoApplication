...
namespace BlueLotus.UI.ApiOperations
{
    public partial class AsynApiOperations
    {
        ...
        public async Task<List<AccNmTyp_SelectMob>> AccNmTyp_SelectMob(string EnvironmentName, int CKy, int UsrKy, int ObjKy, int TrnTypKy, int PreKy)
        {
            string actionUri = "AccNmTyp_SelectMob";
            Dictionary<string, object> paramDictionary = new Dictionary<string, object>();
            ...
            HttpResponseMessage response = await RunApiOperation(
                ...
                EnvironmentName,
                paramDictionary);
            list = await response.Content.ReadAsAsync<List<AccNmTyp_SelectMob>>();
