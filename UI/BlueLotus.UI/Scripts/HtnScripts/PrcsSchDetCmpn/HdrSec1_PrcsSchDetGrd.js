...
$("#HdrSec1_InptPrcsNm").keypress(function (event) {
    var keycode = (event.keyCode ? event.keyCode : event.which);
    if (keycode == '13') {
        loadHdrSec1_PrcsSchDetGrd($("#HdrSec1_InptPrcsNm").val(), '', viewBag.ObjKy,
    1, 1, 1, 1, 'PrjTyp', 'Project');
    }
});
...
function loadHdrSec1_PrcsSchDetGrd(ItemName_SS, dataDt, dataFormObjKy,
    ...
    function loadGrid(col, colData, dataSrcJsonString, spRestCount) {
        ...
        innerDiv.id = 'gridDivHdrSec1_PrcsSchDetGrd' + spRestCount + '';

        // The variable iDiv is still good... Just append to it.
        iDiv.appendChild(innerDiv);

        // Then append the whole thing onto the body
        //document.getElementById("HdrSec1_PrcsSchDetGrd").appendChild(iDiv);
        $("#HdrSec1_PrcsSchDetGrd").append(iDiv);
        ...
        var gridDivHdrSec1_PrcsSchDetGrd = new kendo.data.DataSource({
        ...
        $("#gridDivHdrSec1_PrcsSchDetGrd" + spRestCount + "").kendoGrid({
            //toolbar: ["excel"],
            //excel: {
            //    fileName: "Kendo UI Grid Export.xlsx",
            //    filterable: true
            //},
            dataSource: gridDivHdrSec1_PrcsSchDetGrd,
            sortable: true,
            pageable: false,
            //pageable: {
            //    refresh: false,
        ...
        $("#gridDivHdrSec1_PrcsSchDetGrd" + spRestCount + "").kendoTooltip({
        ...
        $("#gridDivHdrSec1_PrcsSchDetGrd" + spRestCount + "").dblclick(function () {

            var grid = $("#gridDivHdrSec1_PrcsSchDetGrd" + spRestCount + "").data().kendoGrid;
